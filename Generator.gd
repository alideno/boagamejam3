...
func _ready():
	...
	while Number_Y != Board_Y_Size:
		...
		while Number_X != Board_X_Size:
			var temp = TextureButton.new()
			if color:
				temp.texture_normal = load("res://assets/white_board.png")
				temp.texture_pressed = load("res://assets/white_board_clicked.png")
				temp.texture_hover = load("res://assets/white_board_clicked.png")
				temp.texture_focused = load("res://assets/white_board_clicked.png")
				color = !color
			else: 
				temp.texture_normal = load("res://assets/black_board.png")
				temp.texture_pressed = load("res://assets/black_board_clicked.png")
				temp.texture_hover = load("res://assets/black_board_clicked.png")
				temp.texture_focused = load("res://assets/black_board_clicked.png")
				color = !color
